## 更新日志 {docsify-ignore}##
##### [2019.12.10](https://github.com/jin-yufeng/Parser) :id=v20191210 #####
1. `A` 增加了 `cache-id` 属性，可以将解析结果缓存到 `globalData` 中，多次打开不用重复解析 [详细](/instructions#组件属性)  
...
8. `U` `error` 回调将返回该视频的 `context` 对象，可以修改播放源 [详细](/instructions#回调函数)  
...
##### [2019.12.03](https://github.com/jin-yufeng/Parser/commit/e5a26818f3aa98fe3e20b06b1d1130889d0f36d3) :id=v20191202 #####
