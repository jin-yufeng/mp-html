...
Component({
  ...
  methods: {
    ...
    navigateTo(obj) {
      ...
      var selector = swan.createSelectorQuery().in(this._in ? this._in.page : this).select((this._in ? this._in.selector : '._top') + (obj.id ? ' #' + obj.id : '')).boundingClientRect();
